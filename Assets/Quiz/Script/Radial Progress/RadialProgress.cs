...
public class RadialProgress : VisualElement
{
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        UxmlFloatAttributeDescription m_MaximumValueAttribute = new UxmlFloatAttributeDescription() { name = "max-value", defaultValue = 10 };
        ...
        public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
        {
            ...
            (ve as RadialProgress).maximumValue = m_MaximumValueAttribute.GetValueFromBag(bag, cc);
        }
    }
    ...
    public float progress
    {
        ...
        set
        {
            ...
            m_Progress = value;
            // m_Label.text = Mathf.Clamp(Mathf.Round(value), 0, m_MaximumValue).ToString();
            MarkDirtyRepaint();
        }
    }
    ...
    void DrawMeshes(MeshGenerationContext context)
    {
        ...
        // Keep progress between 0 and max value
        float clampedProgress = Mathf.Clamp(m_Progress, 0.0f, m_MaximumValue);
